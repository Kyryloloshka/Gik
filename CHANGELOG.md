...
## [0.1.16](https://github.com/Kyryloloshka/Gik/releases/tag/v0.1.16) - 2026-06-14
...
- apply definitive cargo-dist 0.19.1 configuration with dist-workspace.toml
- switch to official cargo-dist action and bump version to 0.1.16
- apply definitive cargo-dist configuration and bump version to 0.1.15
- final robust release configuration with fixed matrix and version 0.1.14
- repair syntax error in release.yml and bump version to 0.1.13
- correct matrix strategy path for cargo-dist 0.19.1 and bump version to 0.1.12
- restore cross-platform matrix build with all necessary cargo-dist flags
...
- bump version to 0.1.13 for fresh release attempt
- release v0.1.10
- bump version to 0.1.11 and restore full matrix release pipeline
- bump version to 0.1.10 for the first perfect release
- Merge pull request #4 from Kyryloloshka/release-plz-2026-06-14T10-39-02Z
- release v0.1.8
...
## [0.1.11](https://github.com/Kyryloloshka/Gik/releases/tag/v0.1.11) - 2026-06-14
